...
public class Request03Controller {
	...
	//http://localhost:8080/request03/param1?msg=hi&page=1&level=5
	//http://localhost:8080/request03/param1?msg=hello&page=999&level=1231
	@GetMapping("/param1")
	...
	public String param3(HttpServletRequest request) {
		...
		System.out.println("/request/param3");
	...
	@RequestMapping("/param7")//get post
	...
	// GET 요청 			조회/읽기			데이터 조회/단순 화면 전달
	// POST 요청			쓰기/저장			데이터 전달 -> 실제 데이터
	...
	@PostMapping("/param8")
	//param8   param8Actions  param8Process
